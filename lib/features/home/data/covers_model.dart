class CoverModel {
  ...
  static List<CoverModel> covers = [
    CoverModel(image: 'assets/cover/cover10.jpeg', name: 'mystic silhouette'),
    CoverModel(image: 'assets/cover/cover2.jpeg', name: 'veiled gaze'),
    CoverModel(image: 'assets/cover/cover3.jpeg', name: 'crimson mystery'),
    CoverModel(image: 'assets/cover/cover6.jpeg', name: 'shadow grace'),
    ...
    CoverModel(image: 'assets/cover/cover4.jpeg', name: 'runway reflection'),
  ];
}
