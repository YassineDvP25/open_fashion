class CoverModel {
  ...
  static List<CoverModel> displays = [
    CoverModel(image: 'assets/cover/cover1.jpeg', name: 'mystic silhouette'),
    ...
    CoverModel(image: 'assets/cover/cover6.jpeg', name: 'elegant pose'),
